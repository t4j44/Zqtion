...
export default function Overlay() {
  ...
  // Hide overlay completely once past the hero section
  ...
  return (
    <motion.div 
      ...
      className="pointer-events-none absolute inset-0 z-10 flex items-center justify-center mix-blend-difference">
